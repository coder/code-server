...
proto.WorkingInit.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    extraExtensionDirectoriesList: jspb.Message.getField(msg, 9),
    extraBuiltinExtensionDirectoriesList: jspb.Message.getField(msg, 10),
    envMap: (f = msg.getEnvMap()) ? f.toObject(includeInstance, undefined) : [],
    languageTranslateData: jspb.Message.getFieldWithDefault(msg, 12, "")
  };
...
proto.WorkingInit.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 12:
      var value = /** @type {string} */ (reader.readString());
      msg.setLanguageTranslateData(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.WorkingInit.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getLanguageTranslateData();
  if (f.length > 0) {
    writer.writeString(
      12,
      f
...
/**
 * optional string language_translate_data = 12;
 * @return {string}
 */
proto.WorkingInit.prototype.getLanguageTranslateData = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 12, ""));
};


/** @param {string} value */
proto.WorkingInit.prototype.setLanguageTranslateData = function(value) {
