...
# See https://coder.com/docs/code-server/v3.11.2/install
...
More installation docs are at https://coder.com/docs/code-server/v3.11.2/install
EOF
}
...
install_npm() {
  ...
  echoerr "See the docs https://coder.com/docs/code-server/v3.11.2/install#yarn-npm"
