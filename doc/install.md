...
```bash
curl -fOL https://github.com/cdr/code-server/releases/download/v3.5.1/code-server_3.5.1_amd64.deb
sudo dpkg -i code-server_3.5.1_amd64.deb
...
```bash
curl -fOL https://github.com/cdr/code-server/releases/download/v3.5.1/code-server-3.5.1-amd64.rpm
sudo rpm -i code-server-3.5.1-amd64.rpm
sudo systemctl enable --now code-server@$USER
# Now visit http://127.0.0.1:8080. Your password is in ~/.config/code-server/config.yaml
```
...
curl -fL https://github.com/cdr/code-server/releases/download/v3.5.1/code-server-3.5.1-linux-amd64.tar.gz \
  | tar -C ~/.local/lib -xz
mv ~/.local/lib/code-server-3.5.1-linux-amd64 ~/.local/lib/code-server-3.5.1
ln -s ~/.local/lib/code-server-3.5.1/bin/code-server ~/.local/bin/code-server
PATH="~/.local/bin:$PATH"
code-server
# Now visit http://127.0.0.1:8080. Your password is in ~/.config/code-server/config.yaml
```
